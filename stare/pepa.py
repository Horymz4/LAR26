...
def image_segmentation(array, ref_bgr):
    # ---------------------------------------------------------
    # 1) Načtení obrázku
    # ---------------------------------------------------------
    img_f = array.astype(np.float32)
...
def get_ball_position_and_radius(array, ref_bgr):

    # získáme segmentační masku
    mask = image_segmentation(array, ref_bgr)
...
def detect_two_largest_rectangles(array, ref_bgr, min_area=100):
